  ...
  return (
    <Layout className="overflow-y-auto hide-scrollbar">
      ...
      <motion.div
        ...
        className="px-5 pb-8"
      >
        <div className="relative group rounded-[28px] p-[1.5px] bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 overflow-hidden shadow-lg hover:shadow-indigo-500/25 transition-all duration-300">
          ...
          <div className="relative rounded-[26.5px] bg-[var(--bg-card)] p-5 z-10">
            ...
            <div className="grid grid-cols-3 gap-2">
              <a
                ...
                className="flex flex-col items-center justify-center gap-1.5 py-2.5 rounded-[14px] bg-slate-50 dark:bg-slate-800/50 hover:bg-blue-50 dark:hover:bg-blue-900/30 text-[var(--text-secondary)] hover:text-blue-500 transition-colors group/link"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex flex-col items-center justify-center gap-1.5 py-2.5 rounded-[14px] bg-slate-50 dark:bg-slate-800/50 hover:bg-pink-50 dark:hover:bg-pink-900/30 text-[var(--text-secondary)] hover:text-pink-500 transition-colors group/link"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex flex-col items-center justify-center gap-1.5 py-2.5 rounded-[14px] bg-slate-50 dark:bg-slate-800/50 hover:bg-slate-200 dark:hover:bg-slate-700/80 text-[var(--text-secondary)] hover:text-slate-900 dark:hover:text-white transition-colors group/link"
              >
